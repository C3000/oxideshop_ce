...
final class BlockOxIfContentTest extends TestCase
{
    /** @var string  */
    private $cmsContentId = 'test-smarty-content';
    /** @var string  */
    private $unparsedCmsContent = '[{1|cat:2|cat:3}]';
    /** @var string */
    private $parsedCmsContent = '123';
    /** @var string */
