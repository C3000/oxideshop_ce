...
final class FunctionOxEvalTest extends TestCase
{
    /** @var string */
    private $templatePath;
    /** @var string  */
    private $unparsedValue = '[{1|cat:2|cat:3}]';
    /** @var array */
    private $contextData;
    /** @var string */
    private $parsedValue = '123';
    /** @var TemplateRendererInterface */
    private $renderer;
    /** @var string  */
    private $template = '[{oxeval var=$someObject->someProperty}]';
    /** @var string  */
    private $templateWithForceParam = '[{oxeval var=$someObject->someProperty force=1}]';
    ...
    /** Smth. is cached = Number of failing tests is wrong!!!!!!!!!!!!!!!!! */
